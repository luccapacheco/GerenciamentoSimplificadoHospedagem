...
class PagAlterarServicoWidget extends StatefulWidget {
  ...
  State<PagAlterarServicoWidget> createState() =>
      _PagAlterarServicoWidgetState();
}

class _PagAlterarServicoWidgetState extends State<PagAlterarServicoWidget> {
  late PagAlterarServicoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagAlterarServicoModel());
