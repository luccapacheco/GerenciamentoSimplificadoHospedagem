...
class PagAlterarReservasWidget extends StatefulWidget {
  const PagAlterarReservasWidget({
    super.key,
    required this.editarResetvas,
  });

  final CadastroReservasRow? editarResetvas;

  @override
  State<PagAlterarReservasWidget> createState() =>
      _PagAlterarReservasWidgetState();
}

class _PagAlterarReservasWidgetState extends State<PagAlterarReservasWidget> {
  late PagAlterarReservasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagAlterarReservasModel());
