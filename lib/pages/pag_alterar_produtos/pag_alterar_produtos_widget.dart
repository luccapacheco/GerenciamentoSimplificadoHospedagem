...
class PagAlterarProdutosWidget extends StatefulWidget {
  const PagAlterarProdutosWidget({
    super.key,
    required this.alterarProduto,
  });

  final CadastroProdutoRow? alterarProduto;

  @override
  State<PagAlterarProdutosWidget> createState() =>
      _PagAlterarProdutosWidgetState();
}

class _PagAlterarProdutosWidgetState extends State<PagAlterarProdutosWidget> {
  late PagAlterarProdutosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagAlterarProdutosModel());
                                    ...
                                    children: [
                                      Expanded(
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            await CadastroProdutoTable().update(
                                              data: {
                                                'nome': _model
