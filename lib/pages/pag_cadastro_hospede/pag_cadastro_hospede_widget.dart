...
class PagCadastroHospedeWidget extends StatefulWidget {
  const PagCadastroHospedeWidget({super.key});

  @override
  State<PagCadastroHospedeWidget> createState() =>
      _PagCadastroHospedeWidgetState();
}

class _PagCadastroHospedeWidgetState extends State<PagCadastroHospedeWidget> {
  late PagCadastroHospedeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagCadastroHospedeModel());
