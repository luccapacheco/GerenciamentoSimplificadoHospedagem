...
class PagCadastroUsuarioWidget extends StatefulWidget {
  ...
  State<PagCadastroUsuarioWidget> createState() =>
      _PagCadastroUsuarioWidgetState();
}

class _PagCadastroUsuarioWidgetState extends State<PagCadastroUsuarioWidget> {
  late PagCadastroUsuarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagCadastroUsuarioModel());
