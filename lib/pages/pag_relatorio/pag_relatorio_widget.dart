...
class PagRelatorioWidget extends StatefulWidget {
  const PagRelatorioWidget({super.key});

  @override
  State<PagRelatorioWidget> createState() => _PagRelatorioWidgetState();
}

class _PagRelatorioWidgetState extends State<PagRelatorioWidget> {
  late PagRelatorioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagRelatorioModel());
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: FutureBuilder<
                                          ...
                                          future:
                                              CadastroUsuarioTable().queryRows(
                                            queryFn: (q) => q,
                                          ),
                                          builder: (context, snapshot) {
                                            // Customize what your widget looks like when it's loading.
